...
public interface ArticleMapper {
    ...
    @Mapping(target = "sections", expression = "java(article.getSections().stream().map(s -> new ArticleSectionDto(s.getId(), s.getTitre() ,s.getContenu(), s.getImage(), s.getOrdre())).toList())")
